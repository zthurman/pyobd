...
class MyApp(wx.App):
            ...
            while self._notify_window.ThreadControl != 666:
                ...
                if curstate != 7 and self.graph_counter8_1 != 0:
                    ...
                    wx.PostEvent(
                        ...
                        Graphs8Event(
                            [
                                (
                                    self.graph_x_vals8_1,
                                    self.graph_y_vals8_1,
                                    self.unit8_1,
                                    desc8_1,
                                    self.graph_counter8_1,
                                ),
                                (
                                    self.graph_x_vals8_2,
                                    self.graph_y_vals8_2,
                                    self.unit8_2,
                                    desc8_2,
                                    self.graph_counter8_2,
                                ),
                                (
                                    self.graph_x_vals8_3,
                                    self.graph_y_vals8_3,
                                    self.unit8_3,
                                    desc8_3,
                                    self.graph_counter8_3,
                                ),
                                (
                                    self.graph_x_vals8_4,
                                    self.graph_y_vals8_4,
                                    self.unit8_4,
                                    desc8_4,
                                    self.graph_counter8_4,
                                ),
                                (
                                    self.graph_x_vals8_5,
                                    self.graph_y_vals8_5,
                                    self.unit8_5,
                                    desc8_5,
                                    self.graph_counter8_5,
                                ),
                                (
                                    self.graph_x_vals8_6,
                                    self.graph_y_vals8_6,
                                    self.unit8_6,
                                    desc8_6,
                                    self.graph_counter8_6,
                                ),
                                (
                                    self.graph_x_vals8_7,
                                    self.graph_y_vals8_7,
                                    self.unit8_7,
                                    desc8_7,
                                    self.graph_counter8_7,
                                ),
                                (
                                    self.graph_x_vals8_8,
                                    self.graph_y_vals8_8,
                                    self.unit8_8,
                                    desc8_8,
                                    self.graph_counter8_8,
                                ),
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([0, 1, self.current_command8_1.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([1, 1, self.current_command8_2.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([2, 1, self.current_command8_3.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([3, 1, self.current_command8_4.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([4, 1, self.current_command8_5.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([5, 1, self.current_command8_6.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([6, 1, self.current_command8_7.desc]),
                    )
                    ...
                    wx.PostEvent(
                        self._notify_window,
                        Graphs8ValueEvent([7, 1, self.current_command8_8.desc]),
                    )
                ...
                if curstate == 0:  # show status tab
                    ...
                    if first_time_8graphs:
                        ...
                        wx.PostEvent(
                            self._notify_window,
                            BuildComboBoxGraphs8Event(sensor_descriptions),
                        )
                        while not app.build_combobox_graphs8_event_finished:
                            time.sleep(0.01)
                        app.combobox_graphs8_set_sel_finished = False
                        wx.PostEvent(
                            self._notify_window, SetSelectionComboBoxGraphs8Event([])
                        )
                        ...
                        wx.PostEvent(
                            self._notify_window, GetSelectionComboBoxGraphs8Event([])
                        )
                        ...
                        if self.current_command8_1 != None:
                            if (prev_command8_1 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [0, 0, self.current_command8_1.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [0, 1, self.current_command8_1.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_1
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_1 = np.append(
                                    self.graph_x_vals8_1, self.graph_counter8_1
                                )
                                try:
                                    self.graph_y_vals8_1 = np.append(
                                        self.graph_y_vals8_1, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_1 = np.append(
                                        self.graph_y_vals8_1, float(0)
                                    )
                                # self.graph_x_vals1.append(self.graph_counter1)
                                # self.graph_y_vals1.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_1) > 200:
                                    self.graph_x_vals8_1 = np.delete(
                                        self.graph_x_vals8_1, (0)
                                    )
                                    self.graph_y_vals8_1 = np.delete(
                                        self.graph_y_vals8_1, (0)
                                    )
                                    # self.graph_x_vals1.pop(0)
                                    # self.graph_y_vals1.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([0, 2, str(0)]),
                                    )
                                    self.unit8_1 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([0, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_2 != None:
                            if (prev_command8_2 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [1, 0, self.current_command8_2.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [1, 1, self.current_command8_2.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_2
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_2 = np.append(
                                    self.graph_x_vals8_2, self.graph_counter8_2
                                )
                                try:
                                    self.graph_y_vals8_2 = np.append(
                                        self.graph_y_vals8_2, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_2 = np.append(
                                        self.graph_y_vals8_2, float(0)
                                    )
                                # self.graph_x_vals2.append(self.graph_counter2)
                                # self.graph_y_vals2.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_2) > 200:
                                    self.graph_x_vals8_2 = np.delete(
                                        self.graph_x_vals8_2, (0)
                                    )
                                    self.graph_y_vals8_2 = np.delete(
                                        self.graph_y_vals8_2, (0)
                                    )
                                    # self.graph_x_vals2.pop(0)
                                    # self.graph_y_vals2.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([1, 2, str(0)]),
                                    )
                                    self.unit8_2 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([1, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_3 != None:
                            if (prev_command8_3 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [2, 0, self.current_command8_3.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [2, 1, self.current_command8_3.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_3
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_3 = np.append(
                                    self.graph_x_vals8_3, self.graph_counter8_3
                                )
                                try:
                                    self.graph_y_vals8_3 = np.append(
                                        self.graph_y_vals8_3, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_3 = np.append(
                                        self.graph_y_vals8_3, float(0)
                                    )
                                # self.graph_x_vals3.append(self.graph_counter3)
                                # self.graph_y_vals3.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_3) > 200:
                                    self.graph_x_vals8_3 = np.delete(
                                        self.graph_x_vals8_3, (0)
                                    )
                                    self.graph_y_vals8_3 = np.delete(
                                        self.graph_y_vals8_3, (0)
                                    )
                                    # self.graph_x_vals3.pop(0)
                                    # self.graph_y_vals3.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([2, 2, str(0)]),
                                    )
                                    self.unit8_3 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([2, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_4 != None:
                            if (prev_command8_4 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [3, 0, self.current_command8_4.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [3, 1, self.current_command8_4.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_4
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_4 = np.append(
                                    self.graph_x_vals8_4, self.graph_counter8_4
                                )

                                try:
                                    self.graph_y_vals8_4 = np.append(
                                        self.graph_y_vals8_4, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_4 = np.append(
                                        self.graph_y_vals8_4, float(0)
                                    )

                                # self.graph_x_vals4.append(self.graph_counter4)
                                # self.graph_y_vals4.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_4) > 200:
                                    self.graph_x_vals8_4 = np.delete(
                                        self.graph_x_vals8_4, (0)
                                    )
                                    self.graph_y_vals8_4 = np.delete(
                                        self.graph_y_vals8_4, (0)
                                    )
                                    # self.graph_x_vals4.pop(0)
                                    # self.graph_y_vals4.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([3, 2, str(0)]),
                                    )
                                    self.unit8_4 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([3, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_5 != None:
                            if (prev_command8_5 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [4, 0, self.current_command8_5.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [4, 1, self.current_command8_5.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_5
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_5 = np.append(
                                    self.graph_x_vals8_5, self.graph_counter8_5
                                )
                                try:
                                    self.graph_y_vals8_5 = np.append(
                                        self.graph_y_vals8_5, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_5 = np.append(
                                        self.graph_y_vals8_5, float(0)
                                    )
                                # self.graph_x_vals1.append(self.graph_counter1)
                                # self.graph_y_vals1.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_5) > 200:
                                    self.graph_x_vals8_5 = np.delete(
                                        self.graph_x_vals8_5, (0)
                                    )
                                    self.graph_y_vals8_5 = np.delete(
                                        self.graph_y_vals8_5, (0)
                                    )
                                    # self.graph_x_vals1.pop(0)
                                    # self.graph_y_vals1.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([4, 2, str(0)]),
                                    )
                                    self.unit8_5 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([4, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_6 != None:
                            if (prev_command8_6 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [5, 0, self.current_command8_6.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [5, 1, self.current_command8_6.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_6
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_6 = np.append(
                                    self.graph_x_vals8_6, self.graph_counter8_6
                                )
                                try:
                                    self.graph_y_vals8_6 = np.append(
                                        self.graph_y_vals8_6, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_6 = np.append(
                                        self.graph_y_vals8_6, float(0)
                                    )
                                # self.graph_x_vals2.append(self.graph_counter2)
                                # self.graph_y_vals2.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_6) > 200:
                                    self.graph_x_vals8_6 = np.delete(
                                        self.graph_x_vals8_6, (0)
                                    )
                                    self.graph_y_vals8_6 = np.delete(
                                        self.graph_y_vals8_6, (0)
                                    )
                                    # self.graph_x_vals2.pop(0)
                                    # self.graph_y_vals2.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([5, 2, str(0)]),
                                    )
                                    self.unit8_6 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([5, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_7 != None:
                            if (prev_command8_7 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [6, 0, self.current_command8_7.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [6, 1, self.current_command8_7.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_7
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_7 = np.append(
                                    self.graph_x_vals8_7, self.graph_counter8_7
                                )
                                try:
                                    self.graph_y_vals8_7 = np.append(
                                        self.graph_y_vals8_7, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_7 = np.append(
                                        self.graph_y_vals8_7, float(0)
                                    )
                                # self.graph_x_vals3.append(self.graph_counter3)
                                # self.graph_y_vals3.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_7) > 200:
                                    self.graph_x_vals8_7 = np.delete(
                                        self.graph_x_vals8_7, (0)
                                    )
                                    self.graph_y_vals8_7 = np.delete(
                                        self.graph_y_vals8_7, (0)
                                    )
                                    # self.graph_x_vals3.pop(0)
                                    # self.graph_y_vals3.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([6, 2, str(0)]),
                                    )
                                    self.unit8_7 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([6, 2, str(s.value)]),
                                    )
                                    try:
                        ...
                        if self.current_command8_8 != None:
                            if (prev_command8_8 == None) or (
                                ...
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [7, 0, self.current_command8_8.command]
                                    ),
                                )
                                wx.PostEvent(
                                    self._notify_window,
                                    Graphs8ValueEvent(
                                        [7, 1, self.current_command8_8.desc]
                                    ),
                                )
                            else:
                                s = self.connection.connection.query(
                                    self.current_command8_8
                                )
                                if s.value == None:
                                    reconnect()
                                    continue
                                ...
                                #    print("s.value is None!")
                                #    raise AttributeError
                                self.graph_x_vals8_8 = np.append(
                                    self.graph_x_vals8_8, self.graph_counter8_8
                                )

                                try:
                                    self.graph_y_vals8_8 = np.append(
                                        self.graph_y_vals8_8, float(s.value.magnitude)
                                    )
                                except AttributeError:
                                    self.graph_y_vals8_8 = np.append(
                                        self.graph_y_vals8_8, float(0)
                                    )

                                # self.graph_x_vals4.append(self.graph_counter4)
                                # self.graph_y_vals4.append(float(s.value.magnitude))
                                if len(self.graph_x_vals8_8) > 200:
                                    self.graph_x_vals8_8 = np.delete(
                                        self.graph_x_vals8_8, (0)
                                    )
                                    self.graph_y_vals8_8 = np.delete(
                                        self.graph_y_vals8_8, (0)
                                    )
                                    # self.graph_x_vals4.pop(0)
                                    # self.graph_y_vals4.pop(0)
                                ...
                                if s.value == None:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([7, 2, str(0)]),
                                    )
                                    self.unit8_8 = "unit"
                                else:
                                    wx.PostEvent(
                                        self._notify_window,
                                        Graphs8ValueEvent([7, 2, str(s.value)]),
                                    )
                                    try:
    ...
    def build_graphs8_page(self):
        ...
        self.graphs8_list_ctrl = self.MyListCtrl(
            self.graphs8_panel,
            tID,
            pos=wx.Point(0, HOFFSET_LIST),
            style=wx.LC_REPORT | wx.SUNKEN_BORDER | wx.LC_HRULES | wx.LC_SINGLE_SEL,
        ...
        self.graphs8_list_ctrl.InsertColumn(
            1, "Sensor", format=wx.LIST_FORMAT_LEFT, width=320
        )
    ...
    def OnInit(self):
        ...
        EVT_RESULT(
            self, self.GetSelectionGraphs8ComboBox, EVT_COMBOBOXGRAPHS8_GETSELECTION_ID
        )
        EVT_RESULT(
        ...
        EVT_RESULT(
            self, self.SetSelectionGraphs8ComboBox, EVT_COMBOBOXGRAPHS8_SETSELECTION_ID
        )
...
"""
    ...
    def BuildComboBoxGraphs8(self, event):
        self.combobox8_1 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(0, 240)
        )
        self.combobox8_2 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(0, 290)
        )
        self.combobox8_3 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(330, 240)
        )
        self.combobox8_4 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(330, 290)
        )
        self.combobox8_5 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(660, 240)
        )
        self.combobox8_6 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(660, 290)
        )
        self.combobox8_7 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(990, 240)
        )
        self.combobox8_8 = wx.ComboBox(
            self.graphs8_panel, choices=event.data, pos=(990, 290)
        )
    ...
    def OnGraphs8(self, event):
        ...
        def animate():
            if not first_time_graphs8_plot:
                ...
                self.line8_1 = wxplot.PolySpline(
                    xy_data8_1, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_1 = wxplot.PlotGraphics(
                    [self.line8_1], command_desc8_1, "frame", unit8_1
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_1.Destroy()
                        self.panel8_1 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(0, 350)
                        )
                        self.panel8_1.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_1.Draw(
                    self.graphics8_1, xAxis=(graph_counter8_1 - 200, graph_counter8_1)
                )

                self.line8_2 = wxplot.PolySpline(
                    xy_data8_2, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_2 = wxplot.PlotGraphics(
                    [self.line8_2], command_desc8_2, "frame", unit8_2
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_2.Destroy()
                        self.panel8_2 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(0, 580)
                        )
                        self.panel8_2.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_2.Draw(
                    self.graphics8_2, xAxis=(graph_counter8_2 - 200, graph_counter8_2)
                )

                self.line8_3 = wxplot.PolySpline(
                    xy_data8_3, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_3 = wxplot.PlotGraphics(
                    [self.line8_3], command_desc8_3, "frame", unit8_3
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_3.Destroy()
                        self.panel8_3 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(410, 350)
                        )
                        self.panel8_3.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_3.Draw(
                    self.graphics8_3, xAxis=(graph_counter8_3 - 200, graph_counter8_3)
                )

                self.line8_4 = wxplot.PolySpline(
                    xy_data8_4, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_4 = wxplot.PlotGraphics(
                    [self.line8_4], command_desc8_4, "frame", unit8_4
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_4.Destroy()
                        self.panel8_4 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(410, 580)
                        )
                        self.panel8_4.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_4.Draw(
                    self.graphics8_4, xAxis=(graph_counter8_4 - 200, graph_counter8_4)
                )

                self.line8_5 = wxplot.PolySpline(
                    xy_data8_5, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_5 = wxplot.PlotGraphics(
                    [self.line8_5], command_desc8_5, "frame", unit8_5
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_5.Destroy()
                        self.panel8_5 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(820, 350)
                        )
                        self.panel8_5.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_5.Draw(
                    self.graphics8_5, xAxis=(graph_counter8_5 - 200, graph_counter8_5)
                )

                self.line8_6 = wxplot.PolySpline(
                    xy_data8_6, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_6 = wxplot.PlotGraphics(
                    [self.line8_6], command_desc8_6, "frame", unit8_6
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_6.Destroy()
                        self.panel8_6 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(820, 580)
                        )
                        self.panel8_6.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_6.Draw(
                    self.graphics8_6, xAxis=(graph_counter8_6 - 200, graph_counter8_6)
                )

                self.line8_7 = wxplot.PolySpline(
                    xy_data8_7, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_7 = wxplot.PlotGraphics(
                    [self.line8_7], command_desc8_7, "frame", unit8_7
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_7.Destroy()
                        self.panel8_7 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(1240, 350)
                        )
                        self.panel8_7.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_7.Draw(
                    self.graphics8_7, xAxis=(graph_counter8_7 - 200, graph_counter8_7)
                )

                self.line8_8 = wxplot.PolySpline(
                    xy_data8_8, colour="blue", width=1, style=wx.PENSTYLE_SOLID
                )
                self.graphics8_8 = wxplot.PlotGraphics(
                    [self.line8_8], command_desc8_8, "frame", unit8_8
                )
                if sys.platform.startswith("linux"):
                    if (
                        os.environ.get("DESKTOP_SESSION") == "gnome"
                        ...
                        self.panel8_8.Destroy()
                        self.panel8_8 = wxplot.PlotCanvas(
                            self.graphs8_panel, pos=(1240, 580)
                        )
                        self.panel8_8.SetInitialSize(size=wx.Size(400, 220))
                self.panel8_8.Draw(
                    self.graphics8_8, xAxis=(graph_counter8_8 - 200, graph_counter8_8)
                )
